...
namespace InstitutoITLA.Controllers
{
    public class AsignaturasMaestrosController : Controller
    {
        ...
        public AsignaturasMaestrosController(ITLAContext context)
        {
            _context = context;
        }
        // GET: AsignaturasMaestros
        public async Task<IActionResult> MenuAsigtProf()
        {
        ...
        public IActionResult CrearAsigtProf()
        {
        ...
        public async Task<IActionResult> CrearAsigtProf([Bind("AsignaturasMaestrosID,AsignaturasID,ProfesoresID")] AsignaturasMaestros asignaturasMaestros)
        {
            if (ModelState.IsValid)
            {
                _context.Add(asignaturasMaestros);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(MenuAsigtProf));
            }
