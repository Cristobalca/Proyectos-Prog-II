...
namespace InstitutoITLA.Controllers
{
    public class AsignaturasEstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> InicioAsigtStu()
        {
        ...
        public IActionResult CrearAsigtStu()
        {
        ...
        public async Task<IActionResult> CrearAsigtStu([Bind("AsignaturasEstudiantesID,EstudiantesID,AsignaturasID")] AsignaturasEstudiantes asignaturasEstudiantes)
        {
            if (ModelState.IsValid)
            {
                _context.Add(asignaturasEstudiantes);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(InicioAsigtStu));
            }
